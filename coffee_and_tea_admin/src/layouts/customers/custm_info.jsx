...
import { faBackwardStep, faGear, faHistory } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="wrap-add-prd" style={{display: isOpen ? 'flex' : 'none'}}>
        <div className="wrap-add-prd" style={{display: !isShowHistoryPage ? 'flex' : 'none'}}>
            <div className="wrap-lef-add-prd">
                ...
                <CusInfoCPN fileInputRef={fileInputRef} handleUploadClick={handleUploadClick} isUnlockInput={isUnlockInput}/>
            </div>
